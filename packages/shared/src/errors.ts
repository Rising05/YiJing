...
export const ErrorCode = {
  ...
  AI_ANCHOR_INVALID: 'AI_ANCHOR_INVALID',
  AI_ANCHOR_DUPLICATED: 'AI_ANCHOR_DUPLICATED',
...
export const ErrorLabels: Record<ErrorCodeType, string> = {
  ...
  [ErrorCode.AI_SCHEMA_INVALID]: 'AI 结构异常，请重试',
  [ErrorCode.AI_ANCHOR_INVALID]: 'AI 点位异常，请重试',
  [ErrorCode.AI_ANCHOR_DUPLICATED]: 'AI 点位重复，请重试',
  [ErrorCode.LLM_REQUEST_FAILED]: 'AI 服务暂时不可用，请稍后重试',
  [ErrorCode.LLM_EMPTY_RESPONSE]: 'AI 响应为空，请重试',
  [ErrorCode.IMAGE_GENERATION_FAILED]: '图片生成失败，请重试',
  [ErrorCode.IMAGE_STORAGE_FAILED]: '图片保存失败，请重试',
  [ErrorCode.EXPORT_FAILED]: '导出失败，请重试',
  [ErrorCode.FEATURE_NOT_CONFIGURED]: '功能尚未配置，请稍后再试',
